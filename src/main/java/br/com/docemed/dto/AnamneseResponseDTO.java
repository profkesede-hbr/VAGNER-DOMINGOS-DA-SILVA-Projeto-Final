...
/**
 * DTO de resposta contendo a ficha completa de Anamnese do paciente.
 */
public record AnamneseResponseDTO(
        ...
        // ─── SEÇÃO 1: TRICOLOGIA ─────────────────────────────────────────────
        String tipoCabelo,
        String pigmentacaoResidual,
        String caracteristicaCouroCabeludo,

        // ─── SEÇÃO 2: ALIMENTAÇÃO ────────────────────────────────────────────
        String ingereFrutas,
        String ingereLegumes,
        String ingereVerduras,
        ...
        List<RespostaAnamneseDTO> respostasDinamicas
) {
